...
public class WriteTeachingWorker implements Callable<Void> {
    ...
    public Void call() {
        ...
        row.createCell(4).setCellValue(teaching.getSubject().getName() != null ? teaching.getSubject().getName() : "");
        row.createCell(5).setCellValue((teaching.getTeacher().getFirstName() != null || teaching.getTeacher().getLastName() != null) ? teaching.getTeacher().getFirstName() + teaching.getTeacher().getLastName() : "");
        row.createCell(6).setCellValue(teaching.getClassId() != null ? teaching.getClassId() : "");
        row.createCell(7).setCellValue(teaching.getTeachingGroup() != null ? teaching.getTeachingGroup().toString() : "");
        row.createCell(8).setCellValue(teaching.getStatus() != null ? teaching.getStatus() : "");
        row.createCell(9).setCellValue(teaching.getNote() != null ? teaching.getNote() : "");
        return null;
    }
}
